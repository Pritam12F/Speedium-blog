  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-10 grid-rows-5 my-10 mx-5 gap-2">
        <div className="col-span-full rounded-md shadow-zinc-700 shadow-md md:col-span-7 row-span-full">
          <div className="font-semibold text-2xl p-5">{current?.title}</div>
          <div className="p-5">{current?.content}</div>
        </div>
        <div className="col-span-full p-3 row-span-2 rounded-md shadow-zinc-700 shadow-md md:col-span-3">
